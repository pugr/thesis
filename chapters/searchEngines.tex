...
Among the things the solutions have in common is easier integration with an existing application and overall ease of their use when compared with Lucene. 
